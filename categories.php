              ...
              <?php foreach ($all_categories as $cat):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="edit_categories.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                          <span class="glyphicon glyphicon-edit"></span>
                        </a>
                        <a href="delete_categories.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">
