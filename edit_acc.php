...
<div class="row">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-md-8">
              <form class="form" action="edit_acc.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          <form method="post" action="edit_acc.php?id=<?php echo (int)$user['id'];?>" class="clearfix">
            <div class="form-group">
            ...
            <div class="form-group clearfix">
                    <a href="changepass.php" title="change password" class="btn btn-danger pull-right">Change Password</a>
